...
export const events: SeminarEvent[] = [
  {
    ...
    title: {
      ...
      fr: "Le voyage de retour vers l'un",
      es: "El viaje de regreso a la unidad",
      it: "Il viaggio di ritorno all'uno",
      ko: "하나로 돌아가는 여정",
    },
    description: {
      nl: "Een intensieve en persoonlijke middag over identiteit, verbinding en manifestatie.",
      en: "An intensive, personal afternoon on identity, connection and manifestation.",
      de: "Ein intensiver, persönlicher Nachmittag über Identität, Verbindung und Manifestation.",
      fr: "Un après-midi intense et personnel sur l'identité, la connexion et la manifestation.",
      es: "Una tarde intensa y personal sobre identidad, conexión y manifestación.",
      it: "Un pomeriggio intenso e personale su identità, connessione e manifestazione.",
      ko: "정체성, 연결, 현현에 관한 깊이 있고 개인적인 오후.",
    },
    date: "2026-09-19",
    time: "14:00–17:00",
