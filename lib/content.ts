...
export const events: SeminarEvent[] = [
  {
    ...
    description: {
      nl: "Een middag over identiteit, verbinding en manifestatie. Leer opnieuw lachen, contact maken met wat groter is dan jezelf, en dromen in beweging zetten — live, in een warme setting.",
      en: "An afternoon on identity, connection and manifestation. Learn to smile again, connect with something greater than yourself, and set dreams in motion — live, in a warm setting.",
      de: "Ein Nachmittag über Identität, Verbindung und Manifestation. Wieder lächeln lernen, mit dem Größeren in Kontakt kommen und Träume in Bewegung setzen — live, in warmer Atmosphäre.",
    },
    date: "2026-09-19",
    time: "14:00–17:00",
