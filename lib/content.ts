...
export const events: SeminarEvent[] = [
  {
    ...
    description: {
      nl: "Een persoonlijke en inspirerende middag over identiteit, verbinding en manifestatie.",
      en: "A personal and inspiring afternoon about identity, connection and manifestation.",
      de: "Ein persönlicher und inspirierender Nachmittag über Identität, Verbindung und Manifestation.",
      fr: "Un après-midi personnel et inspirant sur l'identité, la connexion et la manifestation.",
      es: "Una tarde personal e inspiradora sobre identidad, conexión y manifestación.",
      it: "Un pomeriggio personale e ispirante su identità, connessione e manifestazione.",
